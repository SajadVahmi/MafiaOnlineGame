...
public interface IDependencyRegister
{
    ...
    void RegisterScoped<TService, TImplementation>() where TImplementation : TService where TService : notnull;

    void RegisterScoped<TService>(Func<TService> factory, Action<TService>? release = null) where TService : class;

    void RegisterSingleton<TService, TImplementation>() where TImplementation : TService where TService : notnull;
    ...
    void RegisterTransient<TService, TImplementation>() where TImplementation : TService where TService : notnull;

    void RegisterDecorator<TService, TDecorator>() where TDecorator : TService where TService : notnull;
