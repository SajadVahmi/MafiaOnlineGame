...
namespace IdentityProvider.ServiceHost.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    private async Task<IdpUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
