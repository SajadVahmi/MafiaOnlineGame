...
namespace IdentityProvider.ServiceHost.Pages.Logout;
...
public class Index : PageModel
{
    ...
    public Index(SignInManager<IdpUser> signInManager, IIdentityServerInteractionService interaction, IEventService events)
    {
