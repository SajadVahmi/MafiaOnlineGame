...
public class PlayersChangeProfileApiTest : PlayersApiTestBase
{
    ...
    public async Task ShouldReturnApiValidationErrorWithSpecifiedPropertyNmaeAndMessage_WhenChangeProfileRequestHasInvalidData(StringContent request, Action<ApiValidationError> assertion)
    {
        //Arrange
        var changeProfileUrl = Endpoints.ChangeProfile.Replace("{playerId}", "1");
    ...
    => new List<object[]>
    {
       new object[]
       {
            ...
            {
                error.PropertyName.Should().Be(nameof(PlayerChangeProfileRequest.FirstName));
       ...
       new object[]
       {
            ...
            new Action<ApiValidationError>(error =>
            {
                error.PropertyName.Should().Be(nameof(PlayerChangeProfileRequest.LastName));
        ...
        new object[]
       {
            ...
            new Action<ApiValidationError>(error =>
            {
                error.PropertyName.Should().Be(nameof(PlayerChangeProfileRequest.BirthDate));
       ...
       new object[]
       {
            ...
            new Action<ApiValidationError>(error =>
            {
                error.PropertyName.Should().Be(nameof(PlayerChangeProfileRequest.Gender));
